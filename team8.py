...
team_name = 'Tristan Jenks team' # Only 10 chars displayed.
strategy_name = 'Operation look back into their history and caloude alot'
...
def move(my_history, their_history, my_score, their_score):
    if len(my_history) < 2:
        ...
        return 'b'
    elif their_history[-1]=='b' and their_history[-2]=='c' and their_history[-3]=='c':
        return 'b'
